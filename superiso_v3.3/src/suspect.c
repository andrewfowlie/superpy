...
/* generates a SLHA file for a CMSSM parameter space point using SUSPECT */
{
	FILE *tmp;
...
/* generates a SLHA file for a GMSB parameter space point using SUSPECT */
{
	FILE *tmp;
	char tmp_char[300],namedir[300];
	char *curdir;
...
/* generates a SLHA file for an AMSB parameter space point using SUSPECT */
{
	FILE *tmp;
	char tmp_char[300],namedir[300];
	char *curdir;
...
/* generates a SLHA file for a pMSSM parameter space point using SUSPECT */
{
	FILE *tmp;
	char tmp_char[300],namedir[300];
	char *curdir;
