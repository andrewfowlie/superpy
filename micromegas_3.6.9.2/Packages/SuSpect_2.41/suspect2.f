...
c  VERSION 2.41  
c  Last modifications : August 1, 2008
...
c writing output in the SLHA format
                open(noutlha,file='suspect2_lha.out',status='unknown')
...
c
      write(*,'(a)')' OUTPUT in SLHA format in suspect2_lha.out '
