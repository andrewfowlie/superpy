...
extern double  Tsynch(double freq,double th, double dth, double phi,double dphi, 
                     double sigmav_,double*SpE,double eps);
extern void setBmagStd(double Bsun, double Bcenter ,double Rcenter);
extern void setBmagNew( double (*newProfile)(double,double));
