CW2*(-((-(Alfa*MW2*(-1 + SW2^(-1) - CW2/SW2))/(2*Pi) - 
     ...
     ((-3*Alfa*CW2*MW2)/(4*Pi*SW2) + 
       (Alfa*((-2*CW2*MZ2)/SW2 + (MW2*SW2)/CW2))/(4*Pi))*
      B0i[bb0, MW2, MW2, MZ2] - (2*Alfa*B0i[bb00, MW2, MW2, 0])/Pi - 
  ...
  (-(Alfa*CW2*MZ2)/(6*Pi*SW2) + (Alfa*(-2 + (9*CW2)/SW2 + SW2/CW2)*A0[MW2])/
    ...
    ((-5*Alfa*CW2*MZ2)/(4*Pi*SW2) + (Alfa*MW2*(-(CW2/SW2) + SW2/CW2))/(2*Pi))*
     B0i[bb0, MZ2, MW2, MW2] - (Alfa*B0i[bb00, MZ2, MH2, MZ2])/
     (4*CW2*Pi*SW2) - (Alfa*(-2 + (9*CW2)/SW2 + SW2/CW2)*
      B0i[bb00, MZ2, MW2, MW2])/(4*Pi) - 
    (Alfa*CW2*MZ2*B0i[bb1, MZ2, MW2, MW2])/(2*Pi*SW2))/MZ2)
