Alfa/(8*Pi*SW2) + (Alfa*(-4 + SW2^(-1) + 4*SW2))/(16*CW2*Pi) + 
 ...
 (Alfa*B0i[bb1, 0, MCha2[Cha3], MSf2[1, 1, 1]]*SumOver[Cha3, 2]*VCha[Cha3, 1]*
   VChaC[Cha3, 1])/(4*Pi*SW2) + 
 (Alfa*B0i[bb1, 0, MNeu2[Neu3], MSf2[Sfe3, 2, 1]]*SumOver[Neu3, 4]*
   SumOver[Sfe3, 2]*USf[Sfe3, 1, 2, 1]*USfC[Sfe3, 1, 2, 1]*
