     ...
     &         - (Mf2(tT,3)*
     &           ((72*MW2 + MB2*(12 - 16*SW2) - 12*Mf2(tT,3))*
     &              (MW2 - Mf2(tT,3)) + 
     &             4*A0(MW2)*
     &              (6*MW2 + MB2*(3 - 4*SW2) + 9*Mf2(tT,3))) - 
     &          4*MW2*A0(Mf2(tT,3))*
     &           (-MB2 + 6*MW2 + (-7 + 16*SW2)*Mf2(tT,3) + 
     &             CW2*(4*MB2 + 16*Mf2(tT,3))))/MZ2)/
     &     (CW2*(MW2 - Mf2(tT,3))**2)
	...
	DCONST "CALSM =", CALSM ENDL
        ...
        CALHp = -(1/24.D0*
     &      (((-1 + 4*CW2)*MB*TB2*Mf(bTR,3) + 3*Mf2(tT,3))*
     &         (MHp2*(A0(Mf2(tT,3)) - Mf2(tT,3)) + 
     &           Mf2(tT,3)*(-A0(MHp2) + Mf2(tT,3))))/
	...
	LOOP(All5, 1,6,1)
        ...
        CALCha = CALCha - 
     &    1/96.D0*((1 + 2*CW2)*CKM(Ind1,3)*CKMC(Ind2,2)*
     &        (-MASf2(All5,3)**2 + 
     &          2*A0(MASf2(All5,3))*
	...
	LOOP(Ind1, 1,3,1)
     ...
     &             dup3*Mf(3,Ind1)*UASf(All5,3 + Ind1,3)*
     &              VChaC(Cha5,2))*
     &           (dup1*(-1 + SW2*(2 - 8*tmp1) + 4*tmp1) + 
     &             CW2*(dup1*(2 - 8*tmp1) - 
     &                8*MZ2*tmp3*VCha(Cha5,1)*VChaC(Cha6,1))))/MZ2)
	...
	LOOP(Ind1, 1,3,1)
     ...
     &        ((-1 + 4*CW2)*UASf(All6,Ind3,3)*UASfC(All5,Ind3,3) - 
     &          4*SW2*UASf(All6,3 + Ind3,3)*UASfC(All5,3 + Ind3,3))
     &         *(UASf(All5,Ind1,3)*
	...
	dup4 = 1 - 4*tmp6
     ...
     &                 (CB*SB*
     &                   (-1 + 4*tmp6 - 
     &                     2*tmp7*MCha(Cha5)*MCha(Cha6))*Mf(bTR,3)*
     &                   UASf(All5,Ind1,3)*UCha(Cha5,2)) + 
     &                2*CB2*dup5*MB*tmp7*MCha(Cha5)) - 
     &             2*CB2*dup5*MB*tmp7*MCha(Cha5)*
     &              (2*UCha(Cha6,1)*UChaC(Cha5,1) + 
     &                UCha(Cha6,2)*UChaC(Cha5,2)))/MZ2)*
     &        UChaC(Cha6,2))/(CB*CB2*CW2*SB*CKM(3,3)*CKMC(3,2))
	...
	LOOP(Ind1, 1,3,1)
     ...
     &        UASf(All5,Ind2,3)*
     &        ((-1 + 4*CW2)*UASf(All6,Ind1,3)*UASfC(All5,Ind1,3) - 
     &          4*SW2*UASf(All6,3 + Ind1,3)*UASfC(All5,3 + Ind1,3))
	...
	dup24 = CW*SW*ZNeuC(Neu5,1) - 3*CW2*ZNeuC(Neu5,2)
        ...
        CALNeu = CALNeu + 
     &    1/108.D0*(tmp2*(UASf(All6,Ind1,bTR)*
     &           (UASfC(All5,Ind1,bTR) + 
     &             2*CW2*UASfC(All5,Ind1,bTR)) - 
     &          2*SW2*UASf(All6,3 + Ind1,bTR)*
     &           UASfC(All5,3 + Ind1,bTR))*
     &        (UASf(All5,3,bTR)*
	...
	LOOP(Ind1, 1,3,1)
        ...
        CARNeu = CARNeu + 
     &    1/108.D0*(tmp4*(UASf(All6,Ind1,bTR)*
     &           (UASfC(All5,Ind1,bTR) + 
     &             2*CW2*UASfC(All5,Ind1,bTR)) - 
     &          2*SW2*UASf(All6,3 + Ind1,bTR)*
     &           UASfC(All5,3 + Ind1,bTR))*
