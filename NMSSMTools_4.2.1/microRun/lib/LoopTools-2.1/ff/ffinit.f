...
*	check whether there is anything to do
	...
	init = 1
c	print *,'===================================================='
c	print *,'  FF 2.0, a package to evaluate one-loop integrals'
c	print *,'written by G. J. van Oldenborgh, NIKHEF-H, Amsterdam'
c	print *,'===================================================='
c	print *,'for the algorithms used see preprint NIKHEF-H 89/17,'
c	print *,'''New Algorithms for One-loop Integrals'', by G.J. van'
c	print *,'Oldenborgh and J.A.M. Vermaseren, published in '
c	print *,'Zeitschrift fuer Physik C46(1990)425.'
c	print *,'===================================================='
*  #] check:
*  #[ precision etc:
	nevent = -1
