...
extern Complex HggF(double z);
extern Complex HggS(double z);
extern Complex HggV(double z);
extern Complex HggA(double z);

extern Complex Hgam1F(double z);
extern Complex Hgam1S(double z);
extern Complex Hgam1A(double z);
