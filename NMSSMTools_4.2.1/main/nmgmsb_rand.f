...
************************************************************************
      ...
      PARAMETER (NFL=19,NPROB=51,NPAR=25)
      INTEGER NFAIL(NFL),IFAIL,I,TOT,ITOT,NTOT,IDUM,ALFLAG
...
*******************************************************************
      ...
      INTEGER NTOT,ISEED,ALFLAG,N0,NLOOP,NBER,NPAR,ERR
...
*********************************************************************      
      ...
      INTEGER ALFLAG,I,J,NRES,IRES,NSUSY,NGUT,NMES,IMAX,IFAIL
      PARAMETER (NSUSY=14,NGUT=21,NMES=15,IMAX=200)
...
*********************************************************************      
      ...
      INTEGER OMGFLAG,MAFLAG,ALFLAG,I,S,TOT,NTOT,NFAIL(*)
