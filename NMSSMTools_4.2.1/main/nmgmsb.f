...
*******************************************************************
      ...
      INTEGER IFAIL,I,ITER,ITERMU,Q2FIX,OMGFLAG,MAFLAG,ALFLAG
...
*******************************************************************
      ...
      INTEGER I,NLINE,INL,ICH,IX,IVAL,Q2FIX,ALFLAG,GMUFLAG,HFLAG
      INTEGER N0,NLOOP,NBER,NPAR,OMGFLAG,MAFLAG,PFLAG,ERR,VFLAG
...
*   Check for errors
 ...
 29   ERR=0
      ...
      IF(XISINP.NE.1d99 .AND. MSINP.NE.1d99)THEN
       ...
       ERR=1
      ENDIF
      IF(ALFLAG.EQ.1 .AND. ALINP.NE.1d99)THEN
       WRITE(0,1)"ALFLAG=1 => ALINP CANNOT BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
      IF(ALFLAG.EQ.1 .AND. MSINP.NE.1d99)THEN
       WRITE(0,1)"ALFLAG=1 => MSINP CANNOT BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
...
*********************************************************************      
      ...
      INTEGER I,IFAIL,OMGFLAG,MAFLAG,PFLAG,ALFLAG,Q2FIX,VFLAG
      ...
      DOUBLE PRECISION G1MES,G2MES,G3MES,LMES,KMES,HTOPMES,
     . HBOTMES,HTAUMES      
      DOUBLE PRECISION SIGMU,PI,MSREF,D,DMIN
     ...
     . HBOTGUT,HTAUGUT      
      ...
      WRITE(17,900) 2,"4.2.1      # Version number"
     ...
     . WRITE(17,900) 4,"# MSMES=/=MSREF"
      ...
      WRITE(17,921) 12,ALFLAG,"scenario 2 of ArXiv:0803.2962"
      ...
      ELSE
       WRITE(17,920) 64,ALINP,"ALAMBDA AT THE MES SCALE"
      ENDIF
      IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-2)THEN
       IF(XIFINP.NE.0d0)
     ...
     .  WRITE(17,901) 69,MSPINP,"MS'^2 AT THE MES SCALE "
      ...
      ENDIF
      IF(ALFLAG.EQ.1)
     . WRITE(17,920) 70,MSREF,"MS^2_REF"
      IF(DHINP.NE.0d0)
     .  WRITE(17,901) 71,DHINP,"DH AT THE MES SCALE"
      
      IF(IFAIL.NE.0.AND.IFAIL.NE.10.AND.IFAIL.NE.18.AND.IFAIL.NE.19)
     .  GOTO 1
 ...
 1    WRITE(18,899) "# HIGGS + TOP BRANCHING RATIOS IN SLHA FORMAT"
      ...
      WRITE(18,900) 2,"4.2.1      # Version number"
