...
*******************************************************************
      ...
      INTEGER I,NLINE,INL,ICH,IX,IVAL,Q2FIX,NMSFLAG,GMUFLAG,HFLAG
      INTEGER ERR,N0,NLOOP,NBER,NPAR,OMGFLAG,MAFLAG,PFLAG,VFLAG
...
*********************************************************************      
      ...
      INTEGER I,NBIN,IFAIL,NMSFLAG,OMGFLAG,MAFLAG,PFLAG,Q2FIX,VFLAG
     ...
     . WRITE(17,900) 3,"# Relic density too small (Planck)"
      IF(PROB(30).EQ.-1d0)
